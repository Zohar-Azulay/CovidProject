...
public class ForgotPassword extends Fragment {
    ...
    private void initializeVariables(){
        try{
            ...
            resetEMailInput=objectForgotFragment.findViewById(R.id.resetEmailV);
            resetPassword=objectForgotFragment.findViewById(R.id.resetPassBtnV);
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        fr.replace(R.id.fragment_container, new editDetV()).addToBackStack("password-reset");
                                        fr.commit();
                                    }
                                    else{
