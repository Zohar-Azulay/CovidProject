...
public class edit_details extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        city_spin = view.findViewById(R.id.edit_details_city);
        change_phone = view.findViewById(R.id.edit_details_cellnumber);
        showDataCitySpinner();
        ...
        btnEditD.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fr_edit.replace(R.id.fragment_pledger_container, new main_p()).addToBackStack("Save changes");
                fr_edit.commit();
            }
        });

        TextView password_reset = view.findViewById(R.id.password_reset);
        password_reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fr_pwReset.replace(R.id.fragment_pledger_container, new ForgotPassword()).addToBackStack("Password reset");
                fr_pwReset.commit();
            }
        });
